...
/*LABELS*/
#can_embed_form label {font-size:18px !important;}
#can_embed_form label.floatlabel-label-active {display:none !important}

/* HIDE LABELS */
#can_embed_form .control-label,
#can_embed_form .affirmative_note {display: none !important;}
...
#can_embed_form input.error_input {
  ...
  box-shadow:0 0 0 2px #FF66FF inset, 0 0 4px 0 #FF66FF inset !important;
}
...
.can_thank_you_wrap h2, .can_thank_you_wrap h4 {display: block !important}
.can_thank_you_wrap div#can_thank_you {background-color: #FFF !important;}
.can_thank_you_wrap #action_info {display:none;}
